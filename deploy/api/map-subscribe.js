...
// Edge runtime + Stripe.createFetchHttpClient() so the function never hangs
// past Vercel's 10s default.
...
export default async function handler(req) {
  ...
  if (req.method === 'POST') {
    ...
    // Lazy-load Stripe SDK with edge-compatible fetch HTTP client
