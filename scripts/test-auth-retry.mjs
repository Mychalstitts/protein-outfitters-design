...
function runOnce() {
  const r = spawnSync(
    process.execPath,
    ['--test', 'test/auth/logout.test.mjs', 'test/auth/me.test.mjs', 'test/auth/request-link.test.mjs', 'test/auth/verify.test.mjs', 'test/connect-onboarding.test.mjs', 'test/connect-split.test.mjs'],
