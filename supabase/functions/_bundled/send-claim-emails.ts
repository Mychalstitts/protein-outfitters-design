// Edge Function: send-claim-emails (single-file bundle for in-dashboard deploy)
//
// Source of truth: app/supabase/functions/send-claim-emails/index.ts
// This bundle inlines the _shared/cors.ts so the Supabase dashboard editor
// can deploy without resolving relative imports.
