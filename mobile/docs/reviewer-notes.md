...
**About the listings:** Listings are sourced from publicly available state meat processor association directories and our live directory. No personal information is shown for any processor — only the business contact information they have already published publicly. Processors can claim their listing (free) or request removal at any time via support@proteinoutfitters.com. Custom-exempt shops are labeled “Custom-exempt / not claimable” and cannot be claimed in the app.
